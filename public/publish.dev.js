...
var packageJson = {
  ...
  "categories": ["Other", "Programming Languages", "Snippets", "Linters", "Debuggers", "Formatters"],
  "keywords": ["sass", "beautify", "scss", "typescript", "ts", "less", "ES6", "ES5", "JS", "css", "javascript", "html", "compile", "translate", "tsx", "jade", "hero", "close", "port", "pug", "easysass", "easy", "super", "minified", "format", "json", "formatter", "formate"],
  "activationEvents": ["*", "onCommand:compile-hero.openInBrowser", "onCommand:compile-hero.closePort", "onCommand:compile-hero.compileFile", "onCommand:compile-hero.compileHeroOn", "onCommand:compile-hero.compileHeroOff", "onCommand:compile-hero.beautify", "onCommand:compile-hero.beautifyFile"],
...
var deleteVsix = function deleteVsix(uri) {
